...
export function UserStatisticsModal({ userId, isOpen, onClose }: UserStatisticsModalProps) {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="max-w-full sm:max-w-7xl max-h-[90vh] overflow-y-auto w-[95vw]">
        <DialogHeader>
          <DialogTitle>User Profile & Statistics</DialogTitle>
          <DialogDescription>
            Comprehensive analytics and activity overview
          </DialogDescription>
        </DialogHeader>
          ...
          <div className="space-y-6">
            ...
            <div className="flex items-center gap-4 p-4 bg-muted/50 rounded-lg">
              ...
              <div className="text-right">
                ...
                <div className="text-2xl font-bold text-primary">{stats.user.daysSinceJoined}</div>
